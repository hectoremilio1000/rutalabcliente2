const products = [
    {
        ...
        oldPrice:1600,
        tiempoResultado:30,
        descripcion:"Método específico para determinar la presencia del virus del virus que produce la enfermeda COVID-19 al momento. Idealmente se utiliza en pacientes que presentan síntomas agudos para confirmar la enfermedad. Es recomendada si el paciente tuvo contacto con una persona diagnosticada, incluso si no presenta síntomas; también es solicitada para fines de viajes e intervenciones médicas, entre otras."
    },
    {
        id:'2',
    ...
    },
    {
        ...
        oldPrice:200,
        tiempoResultado:30,
        descripcion:"Una prueba de embarazo puede indicar si usted está embarazada analizando una hormona específica producida durante el embarazo. La hormona se llama gonadotropina coriónica humana (GCH). La GCH se produce en la placenta de la mujer después de que un óvulo fertilizado se ha implantado en el útero. Normalmente se produce sólo durante el embarazo."
    },
    {
        id:'4',
    ...
    },
    {
        ...
        oldPrice:550,
        tiempoResultado:30,
        descripcion:"La Química Sanguínea es un análisis de sangre que permite conocer algunos parámetros del cuerpo humano, en este caso, los niveles de Glucosa, Colesterol y Triglicéridos. Esto para brindar un panorama general del estado de salud del paciente. Este examen ayuda a identificar los niveles de glucosa en la sangre o la presencia de diabetes tipo I o II, al medir el colesterol y los triglicéridos se pueden diagnosticar enfermedades cardiovasculares."
    },
    {
        id:'6',
